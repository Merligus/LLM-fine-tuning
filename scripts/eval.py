...
if dataset_name == "Abirate/english_quotes":
    dataset = EnglishQuotesDataset(dataset_name, tokenizer.bos_token, tokenizer.eos_token)

# Get predictions and references
eval_predictions, eval_references = eval(model, tokenizer, dataset.eval_dataset)
